...
PodNames.prototype.writePodStyleName = function(patches) {
  ...
  // Make sure we preserve all known pod-names when multiple copies of
  // ember-component-css are running (e.g. when using addons/engines)
  var newPodNames = Object.assign(
    global.__emberComponentCssPodNames || {}, 
    currentPodNames, 
    this.podNameJson
  );
  global.__emberComponentCssPodNames = newPodNames;
